...
<html lang = "en">
    <head>
        ...
        <title>Arrivederci Pizza Place | Round Crust</title>
    ...
    <body>
        ...
        <!------------ single round pizza details --------->

        <figure>
        
            <img src="Images/roundcrust.png" alt="12"pizza" style="width: 100px" /><br>
            <figcaption>
    ...
    <figure>
            ...
            <img src="Images/roundcrust.png" alt="14" pizza" style="width: 200px" />
            <figcaption>
    ...
    <figure>
            ...
            <img src="Images/roundcrust.png" alt="16" piozza" style="width: 300px" />
            <figcaption>
    ...
    <div class="container-pyi">
        <form>
            ...
            <div class="submitbar">
                <a href="thincrust.php"><button class ="button">Start Over</button></a>
                <a href="cart.php"><button class="button">Submit To Cart</button></a>
            </div>
        </form>
    </div>
